...
var Scroller = class _Scroller extends BaseComponent {
  ...
  getContentPosition() {
    if (this.contentEl) {
      const style7 = getComputedStyle(this.contentEl);
      const left = parseFloat(style7.paddingLeft) + Math.max(parseFloat(style7.left) || 0, 0);
      const right = parseFloat(style7.paddingRight) + Math.max(parseFloat(style7.right) || 0, 0);
      const top = parseFloat(style7.paddingTop) + Math.max(parseFloat(style7.top) || 0, 0);
      const bottom = parseFloat(style7.paddingBottom) + Math.max(parseFloat(style7.bottom) || 0, 0);
      return {
        left,
        right,
        top,
...
@angular/animations/fesm2022/animations.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-5YGIF2TK.js.map
